    ...
    Box(
        ...
        BackgroundCorneredWithBorder(
            ...
            Column(
                ...
                Title1(
                    text = stringResource(id = R.string.story_process_reset_confirmation_title),
                ...
                Row(horizontalArrangement = Arrangement.Center) {
                    Button(
                        state = ButtonViewState(
                            title = stringResource(id = R.string.common_yes),
                    ...
                    Button(
                        state = ButtonViewState(
                            title = stringResource(id = R.string.common_no),
                            backgroundColor = AppColors.Grey
                        ),
                        onClick = {
                            onDismissClicked()
