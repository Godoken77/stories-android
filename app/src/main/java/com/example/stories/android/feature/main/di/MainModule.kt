...
import com.example.stories.android.feature.main.domain.usecase.RecentlyStoriesUseCaseImpl
...
internal interface MainModule {
    ...
    @Binds
    fun bindRecentlyStoriesUseCase(impl: RecentlyStoriesUseCaseImpl): RecentlyStoriesUseCase
}