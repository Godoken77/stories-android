        ...
        storyParts = listOf(
            StoryPart(
                ...
                articles = listOf(
                    ...
                    Article(
                        id = "4",
                        text = "\"Могу я предложить вам что-то?\" — спросил он, пытаясь говорить уверенно"
                    ),
                    Article(
                        id = "5",
                        text = "Женщина улыбнулась. — Думаю, ты уже знаешь, чего я хочу, — промурлыкала она."
                    ),
                    Article(
                        id = "6",
                    ...
                    Article(
                        id = "24",
                        text = "\"Вы были отмечены,\" сказала она приглушенным голосом. «Суккуб оставила на тебе свой отпечаток, и теперь ты связан с ней. Ты уже не совсем человек, но ты еще и не порождение ночи. Твоя судьба по-прежнему в твоих руках»."
                    ),
                    Article(
                        id = "25",
